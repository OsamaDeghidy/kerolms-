  ...
  return (
    <div className="max-w-4xl mx-auto pb-20">
       <div className="flex justify-between items-center mb-8">
          <div>
             <h1 className="text-3xl font-black">إضافة <span className="text-primary italic">تحليل جديد</span></h1>
             <p className="text-foreground-muted text-sm italic font-medium">ابدأ الآن بمشاركة رؤيتك للسوق مع طلابك</p>
          </div>
       ...
       <form onSubmit={handleSubmit} className="space-y-8">
             ...
             <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-2 md:col-span-2">
                   ...
                   <input 
                     ...
                     placeholder="مثال: تحليل البيتكوين - اختراق القمة التاريخية"
                   />
                </div>
                ...
                <div className="space-y-2 md:col-span-2">
                   ...
                   <input 
                     ...
                     placeholder="ادخل رابط الفيديو أو ID البث المباشر..."
                   />
                </div>
                ...
                <div className="space-y-2 md:col-span-2">
                   ...
                   <textarea 
                     ...
                     placeholder="اكتب تفاصيل التحليل والنقاط المهمة التي تم ذكرها..."
                   />
                </div>
             </div>
          </div>
          ...
          <div className="flex justify-end gap-4">
             ...
             >
                {loading ? "جاري الحفظ..." : "حفظ ونشر التحليل"}
             </button>
          </div>
       </form>
    </div>
