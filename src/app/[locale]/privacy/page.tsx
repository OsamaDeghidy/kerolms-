            ...
            <div className="relative z-10">
              <div className="flex items-center gap-6 mb-12">
                 ...
                 <div className="space-y-1">
                    <h1 className="text-4xl lg:text-5xl font-black italic uppercase tracking-tighter">{t('privacy_title')}</h1>
              ...
              <div className="prose prose-invert max-w-none space-y-12">
                 ...
                 <div className="grid gap-8">
                    <LegalSection 
                      title={t('privacy_p1_title')} 
                      content={t('privacy_p1_content')} 
                      isRtl={isRtl}
                    />
                    <LegalSection 
                      title={t('privacy_p2_title')} 
                      content={t('privacy_p2_content')} 
                      isRtl={isRtl}
                    />
                 </div>
              </div>
